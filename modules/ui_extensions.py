    ...
    "Disable all extensions" was set, change it to "none" to load all extensions again
            ...
            with gr.TabItem("Available", id="available"):
                with gr.Row():
                    ...
                    available_extensions_index = gr.Text(value="https://raw.githubusercontent.com/zetclansu/lite-kaggle-assets/main/extensions.json", label="Extension index URL").style(container=False)
